...
<head>
   ...
   <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="/textcss" href="/assets/select2/select2.min.css">
</head>
                ...
                <div class="row">
                      <div class="col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="pageheader-caption">
                            <h1 class="pageheader-caption-title">Send Inquiry</h1>
                            <p class="pageheader-caption-text">Lorem ipsum dolor sit amet, consecteturconsectetur adipiscing eliorbi fringilla ipsum tellusa varius loremid loremid blandit. </p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="offset-xl-2 col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="inquiry-form">
                            <h3 class="inquiry-form-title">We can help you list your space, just send us a short message.</h3>
                            <h5 class="mb-4">Choose Your Space Type</h5>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="officespace">
                                        <label class="custom-control-label" for="officespace">Office Space</label>
                                    </div>
                                </li>
                                <li class="list-inline-item">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="eventspace">
                                        <label class="custom-control-label" for="eventspace">Event Space</label>
                                    </div>
                                </li>
                                <li class="list-inline-item">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="coworkingspace">
                                        <label class="custom-control-label" for="coworkingspace">Coworking Space</label>
                                    </div>
                                </li>
                                <li class="list-inline-item">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="retailspace">
                                        <label class="custom-control-label" for="retailspace">Retail Space</label>
                                    </div>
                                </li>
                                <li class="list-inline-item">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="meetingspace">
                                        <label class="custom-control-label" for="meetingspace">Meeting Space</label>
                                    </div>
                                </li>
                            </ul>
                             ...
                             <form class="form-row">
                                        <div class="form-group col-6">
                                            <label for="inquiryname">Name<span class="form-remark">*</span></label>
                                            <input type="text" name="name" class="form-control" id="inquiryname" aria-describedby="inquiryname" placeholder="John Deo" required="">
                                        </div>
                                        <div class="form-group col-6">
                                            <label for="inquiryemail">Email<span class="form-remark">*</span></label>
                                            <input type="email" name="email" class="form-control" id="inquiryemail" aria-describedby="inquiryemail" placeholder="Enter email" required="">
                                        </div>
                                        <div class="form-group col-6">
                                            <label for="inquiryphone">Phone<span class="form-remark">*</span></label>
                                            <input type="tel" name="phone" class="form-control" id="inquiryphone" aria-describedby="inquiryphone" placeholder="+91" required="">
                                        </div>
                                       <div class="form-group col-6">
                                            <label for="companyname">Company Name<span class="form-remark">*</span></label>
                                            <input type="text" name="name" class="form-control" id="companyname" aria-describedby="companyname" placeholder="example" required="">
                                        </div>
                                         <div class="form-group col-6">
                                            <label for="country">Country</label>
                                            <select class="select2 custom-select" id="country">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <select class="select2 custom-select" id="city">
                                        ...
                                        <div class="form-group col-12">
                                            <label for="inquirydescription">Message</label>
                                            <textarea class="form-control" id="inquirydescription" rows="4" placeholder="Write short message"></textarea>
                                        </div>
                                        <button type="submit" class="btn btn-primary btn-block">Send Inquiry</button>
                                        <div class="inquiry-bottom-text">
                                          <small class="form-remark-text"><span class="form-remark">*</span> Required Filed</small>
