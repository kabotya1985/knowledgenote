                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-7 col-sm-12 col-12">
                        <div class="listing-detail-header" id="overview">
                            ...
                            <div class="listing-detail-head">
                                <h2 class="listing-detail-head-title">Heading Title for Office Space Building</h2>
                                <p class="listing-detail-head-text"><span class="map-icon"><i class="fas fa-map-marker-alt"></i></span>26, Deccan Gymkhana, Ludhiana - 369227 <a href="#location" class="btn-link ml-2 page-scroll">See Location</a></p>
                            </div>
                        ...
                        <!-- listing detail close -->
                        <!-- listing detail start -->
                        <div class="listing-detail-card reviews" id="review">
                            <div class="d-lg-flex justify-content-between mb-4">
                                <h4 class="listing-detail-card-title mb-xl-0 pt-xl-2">2 Review on office space listing</h4>
                                <a href="#reviewform" class="btn btn-primary page-scroll">Write a review</a>
                            </div>
                            <div class="review-block">
                                <div class="review-block-img"><img src="/assets/images/avatar-1.jpg" alt="" class="rounded-circle"></div>
                                <div class="review-content">
                                    <div class="review-content-head">
                                        ...
                                        <div class="review-content-rating">
                                            ...
                                            <span class="review-content-date">30 May, 2019</span>
                                        </div>
                                    </div>
                            ...
                            <div class="review-block">
                                <div class="review-block-img"><img src="/assets/images/avatar-2.jpg" alt="" class="rounded-circle"></div>
                                <div class="review-content">
                                    <div class="review-content-head">
                                        <h3 class="review-content-title">Yami Myles</h3>
                                        <div class="review-content-rating">
                                            <span class="star"></span>
                                            <span class="star"></span>
                                            <span class="star"></span>
                                    ...
                                    <p class="review-content-heading-text text-dark">Awesome office space</p>
                                    <p class="review-content-text">Aliquam porttitor, purus eleifend egestas finibus, orci neque dictum metus, et finibus elit dui sit amet nibh. Ut eu nibh etspendisse lacinia accumsan felis. Aliquam porttitor, purus eleifend egestas finibus, orci neque dictum metus et finibus elit dui sit amet nibh.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <!-- listing detail close -->
                        <!-- listing detail start -->
                        <div class="listing-detail-card review-form " id="reviewform">
                            <h4 class="listing-detail-card-title">Write a Review</h4>
                            <div id="rating-star" class="mb-3"></div>
                            <form class="form-row">
                                <div class="form-group col-12">
                                    <label for="reviewtitle">Review Title<span class="require-mark">*</span></label>
                                ...
                                <div class="form-group col-6">
                                    <label for="reviewtitle">Name<span class="require-mark">*</span></label>
                                    <input type="text" name="name" class="form-control" id="reviewname" aria-describedby="reviewname" placeholder="John Deo" required="">
                                </div>
                                <div class="form-group col-6">
                                    <label for="reviewemail">Email<span class="require-mark">*</span></label>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-5 col-sm-12 col-12">
                        ...
                        <div class="listing-sidebar">
                            ...
                            <!-- listing widget start -->
                            <div class="listing-sidebar-widget">
                                <h3 class="listing-widget-title">Contact a Property Owner</h3>
                                <div class="listing-sidebar-widget-content">
