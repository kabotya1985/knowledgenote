                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="db-pageheader d-xl-flex justify-content-between">
                                    <div class="">
                                        <h2 class="db-pageheader-title">Listing Management</h2>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="dashboard-add-listing.html" class="btn btn-primary"> Add new listing</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
>Action</th>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="listing-table-head">
                                                                    <h4 class="listing-table-head-title"><a href="#" class="anchor-title">Heading Title Office Space Title</a></h4>
                                                                    <p class="listing-table-head-text">Ahmedabad, Gujarat, India</p>
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="listing-table-review">2</div>
                                                            </td>
                                                            <td>
                                                                <div class="listing-table-quote">3</div>
                                                            </td>
                                                            <td>
                                                                <div class="listing-table-status">
